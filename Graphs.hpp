...
// Function Prototypes___________________
    ...
    int  No_of_Vertices() const;        // Get number of vertices (V)
    ...
    void display_sentences();//display the two sentences displaying the vertices and edges
...
//______________________________________________________________________________________________
   ...
   private:
       ...
       int minimum_path(vector<pair<int,string>>distance, bool flag[]);
       void print_function(vector<pair<int,string>>distance,int s);
